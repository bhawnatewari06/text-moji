...
function btnClicking() {
    ...
    document.querySelector("#dec-btn").addEventListener("click", function () {
        ...
        document.querySelector("#dec-btn").style.backgroundColor = "#ffe4c4"
        document.querySelector("#enc-btn").style.backgroundColor = "#ffffff"
    ...
    document.querySelector("#enc-btn").addEventListener("click", function () {
        ...
        document.querySelector("#dec-btn").style.backgroundColor = "#ffffff"
        document.querySelector("#enc-btn").style.backgroundColor = "#ffe4c4"
